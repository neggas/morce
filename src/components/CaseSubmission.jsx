...
const CaseSubmission = ({ onCaseSubmitted }) => {
  ...
  const handlePayment = () => {
    toast({
      title: "🚧 Paiement en développement",
      description: "L'intégration de Stripe est en cours. Nous simulons un paiement réussi pour continuer.",
    });
    handleSubmit();
  };
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div className="legal-disclaimer">
                    ...
                    <p className="text-text-secondary text-xs">En procédant au paiement, vous acceptez que l'analyse est non-contraignante et que MORICE ne fournit pas de conseils juridiques.</p>
                  </div>
                </div>
                <div className="bg-dark-bg/50 rounded-lg p-6 border border-dark-border">
